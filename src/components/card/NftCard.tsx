...
const NftCard = (props: {
  ...
  return (
    <Card
      className={`flex flex-col w-full h-full !p-4 3xl:p-![18px] bg-white dark:bg-slate-950 ${extra}`}
    >
      <div className="h-full w-full">
        ...
        <div className="mb-3 flex items-center justify-between px-1 md:flex-col md:items-start lg:flex-row lg:justify-between xl:flex-col xl:items-start 3xl:flex-row 3xl:justify-between">
          ...
          <div className="flex flex-row-reverse md:mt-2 lg:mt-0">
            <span className="z-0 ml-px inline-flex h-8 w-8 items-center justify-center rounded-full border border-white bg-[#E0E5F2] text-xs text-slate-950 dark:!border-navy-800 dark:bg-gray-800 dark:text-white">
              +5
            </span>
            {bidders.map((avt, key) => (
              <span
