...
const PieChartCard = () => {
  return (
    <Card extra="rounded-[20px] p-3">
      ...
      <div className="flex flex-row !justify-between rounded-2xl px-6 py-3 shadow-2xl shadow-shadow-500 dark:!bg-slate-950 dark:shadow-none">
        <div className="flex flex-col items-center justify-center">
          <div className="flex items-center justify-center">
            <div className="h-2 w-2 rounded-full bg-brand-500" />
            <p className="text-sm font-normal text-gray-600 ms-1">Your Files</p>
          </div>
          <p className="mt-px text-xl font-bold text-slate-950  dark:text-white">
            63%
          </p>
        </div>
